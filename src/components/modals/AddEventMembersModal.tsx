...
import './AddEventMembersModal.css';
...
const AddEventMembersModal: React.FC<AddEventMembersModalProps> = ({
    isOpen,
    onClose,
    onMembersAdded,
    eventId,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await api.editEvent(eventId, {
                members_to_add: newMemberIds
            });
            ...
            setError(err instanceof Error ? err.message : 'Failed to add members to event');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="add-event-members-modal-overlay" onClick={handleModalOverlayClick}>
            <div className="add-event-members-modal" onClick={handleModalClick}>
                <div className="modal-header">
                    <h2>Add People to "{eventTitle}"</h2>
                ...
                <div className="modal-body">
                    ...
                    <div className="form-group">
                        <label htmlFor="event-members">Select people to add:</label>
...
export default AddEventMembersModal; 